...
void BMP_GetPixelRGBA( BMP* bmp, UINT x, UINT y, UCHAR* r, UCHAR* g, UCHAR* b, UCHAR* a )
{
	UCHAR*	pixel;
	UINT	bytes_per_row;
	UCHAR	bytes_per_pixel;
...
void BMP_SetPixelRGBA( BMP* bmp, UINT x, UINT y, UCHAR r, UCHAR g, UCHAR b, UCHAR a )
{
	UCHAR*	pixel;
	UINT	bytes_per_row;
	UCHAR	bytes_per_pixel;
